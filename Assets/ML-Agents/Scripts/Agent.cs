...
public abstract class Agent : MonoBehaviour
{
    ...
    /// event, created to
    /// facilitate testing.
    private void OnEnableHelper(Academy academy)
    {
        info = new AgentInfo();
    ...
    /// </summary>
    /// <param name="academyMaxStep">
    ///     If set to <c>true</c>
    ///     The agent must set maxStepReached.
    /// </param>
    /// <param name="academyDone">
    ///     If set to <c>true</c>
    ///     The agent must set done.
    /// </param>
    private void SetStatus(bool academyMaxStep, bool academyDone, int academyStepCounter)
    {
        if (academyDone) academyStepCounter = 0;
        MakeRequests(academyStepCounter);
        if (academyMaxStep) maxStepReached = true;
    ...
    /// </summary>
    protected virtual void MakeRequests(int academyStepCounter)
    {
