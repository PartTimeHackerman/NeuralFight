    ...
    public class EditModeTestReset
    {
        ...
        public void TestAgent()
        {
            ...
            for (var i = 0; i < 5000; i++)
            {
                ...
                if (i == 2) AgentEnableMethod.Invoke(agent1, new object[] {aca});
                // ResetPosition Academy every 100 steps
                if (i % 100 == 3)
                {
                    aca.Done();
                    numberAcaReset += 1;
                ...
                if (agent1.IsDone() &&
                    acaStepsSinceReset % agent1.agentParameters.numberOfActionsBetweenDecisions == 0 || aca.IsDone())
                {
                    numberAgent1Reset += 1;
    ...
    public class EditModeTestMiscellaneous
    {
        ...
        public void TestResetOnDone()
        {
            ...
            for (var i = 0; i < 50; i++)
            {
                ...
                if (i > 2 && i % 21 == 0) agent1ResetOnDone = 1;
