...
public class AgentEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        if (GUILayout.Button("Add Camera", EditorStyles.miniButton)) cameras.arraySize++;
        if (GUILayout.Button("Remove Camera", EditorStyles.miniButton)) cameras.arraySize--;
