...
public class Observations : MonoBehaviour
{
    ...
    {
        positions.Clear();
        foreach (var gameObject in rigids)
        {
    ...
    {
        velocity.Clear();
        foreach (var rigidbody in rigids) velocity.Add(rigidbody.velocity);
        return velocity;
    }
    ...
    {
        angVel.Clear();
        foreach (var rigidbody in rigids) angVel.Add(rigidbody.angularVelocity);
        return angVel;
    }
    ...
    {
        return physics.getCenterOfMass(rigids);
    }
